...
/**
 * Select nativo estilizado. Suficiente para catálogos simples (sector, país, rol)
 * y 100% compatible con Server Actions vía FormData, sin estado de cliente extra.
 */
